...
# Wir sind als Team gewachsen. Und das nur wegen eines Boards.
...
## Ein Motor für Veränderung ist das Streben nach Einfachheit
...
Der nächste Halt ist schnell erreicht, denn die Umstrukturierung ließ sich in unserem Projekttool Jira schnell erledigen. Die größte Veränderung war das Aufteilen in zwei Boards, die jeweils ihren eigenen Fokus haben. Beginnen wir mit dem **Umsetzungsboard**, bei dem es sich um die Evolution aus der bis dato bestehenden Visualisierung handelt:
...
1. Die Aufgaben liegen zu Beginn nach Wichtigkeit vom PM (oder PO/Teamlead/…) sortiert und bereits mit dem Kunden ausgearbeitet in der ersten Spalte namens ```Up Next```.
2. Zu gegebener Zeit holen wir uns als Team ein Set an Aufgaben rüber in ```Preparation``` und schauen uns diese an, bevor wir mit der tatsächlichen Umsetzung beginnen. Wir die für uns offenen Fragen und Unklarheiten, die während des Kunde-PM-Austauschs nicht aufgefallen sind. Somit sorgen wir dafür, dass wir die Aufgabe flüssig ohne Unterbrechungen umsetzen können.
