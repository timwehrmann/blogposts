...
# Board(r)evolution - Optimierung des Flows durch die Power von Teams
Schön, dass du dich für diesen Erfahrungsbericht interessierst. Im Kern geht es um Verantwortung, Selbstorganisation des Teams und die daraus entstehende Freiheit. Es geht auch um Unzufriedenheit und Frustration. Es geht vor allem um das Gefühl, dass wir als Team stark genug geworden sind, den nie enden wollenden Berg an auf uns einprasselnden Aufgaben guten Gewissens entgegentreten zu können, egal wie übermächtig groß ebenjener Berg auch mal erscheinen mag. Diese Reise ging über das letzte halbe Jahr und es hat uns mehr als nur einen Schritt nach vorne gebracht. :)

Der Startpunkt dieser Reise ist dabei so schlicht, dass kein Coach dieser Welt dazu eine Story auf LinkedIn posten würde: Wir haben unser Board umorganisiert, über das wir unsere Arbeit visualisieren. Die ganzen Effekte, die das aber mit sich bringt, haben wir alle zu Beginn nicht kommen sehen:
...
Kurzum: Wir reden mehr miteinander über unsere Arbeit!

## Unser Motor für Veränderung ist das Streben nach Einfachheit

Man kann es mit einer Zugfahrt vergleichen, die am Bahnhof Unzufriedenheit beginnt: Irgendwie finden wir alle die Art und Weise ineffektiv, wie wir kollaborativ unsere Aufgaben, Stories und Issues abarbeiten. Es schwelt diffus unter der Oberfläche, ohne dass wir es klar benennen können. Unsere Arbeit plätschert rein, wie sie es schon immer getan hat und unsere Visualisierung wurde irgendwann mal bestimmt und hat sich seitdem nicht großartig verändert. Mitarbeiter kommen und gehen, die Prozesse aber bleiben. Wir als Team haben beschlossen, dass wir aktiv werden und etwas verändern müssen. Das ist nicht einfach; schließlich gilt es, möglichst viele Köpfe mit zum Teil diametral zueinander liegenden Meinungen zu Kompromissen zu bewegen und letztlich unter einen Hut zu bekommen. Auf eins können wir uns aber immer einigen: Wir wollen einen einfachen, am besten selbsterklärend-natürlichen Workflow, bei dem man sich nicht den Kopf zerbrechen muss und der uns hilft, gute Software schnell zu liefern.

# Ermittle unintuitive Verhaltensweisen

![alt text](Grafiken/AltesBoard.png)

Während wir uns in Bewegung zum nächsten Halt setzen, müssen wir uns den Status Quo vor Augen führen. Die von uns abzuarbeitenden Aufgaben sind unterschiedlich groß: Mal müssen wir fünf Minuten in die Umsetzung investieren, mal sind zwei Leute drei Wochen gebunden. Jede dieser Aufgaben wird vom Team in kleinere Häppchen (= Subtasks) zerteilt, damit wir strukturiert und planvoll vorgehen. Das hat den positiven Nebeneffekt, dass bei mittlerem und größerem Aufgabenumfang bei sinnvoller Zerteilung prinzipiell zwei (und mehr) Personen parallel an derselben Sache arbeiten können. Diese kleinen Happen wandern durch die Spalten von links nach rechts. ```ToDo ``` ist das Sammelbecken für die noch zu erledigenden Tasks, die Karten in ```In Progress ``` werden gerade beackert und ```QA``` bedeutet, dass ein Kollege seine Arbeit geprüft haben möchte. Dann gibt es ```ONHOLD``` für Dinge, die gerade aus mannigfaltigen Gründen nicht weitergehen können. Wenn wir auf eine Abnahme des Kunden für einzelne Dinge warten, kommt es in die Spalte ```Customer QA ```. Und am Ende ist alles ```Done```.
...
1. Die Aufgaben liegen zu Beginn nach Wichtigkeit vom PM (oder PO/Teamlead/SRM/…) sortiert in der ersten Spalte namens ```Up Next```.
...
4. Wenn ein Teammitglied auf dem Umsetzungsboard nun keine Aufgabe findet, an der er oder sie mitarbeiten kann, bedient er sich aus diesem Pool der vorbereiteten Aufgaben und zieht es sich in ```Development```. Die tatsächliche Arbeit findet dann auf dem Umsetzungsboard statt, auf dem nur noch die Elemente angezeigt werden, die sich auch tatsächlich in der Umsetzung befinden. Das sorgt für eine drastische Reduzierung und eine massiv verbesserte Übersicht über unser tatsächlich stattfindendes Doing und unterstützt somit alle täglichen Planungsmeetings wie z.B. unser Daily. 
5. Wenn eine Aufgabe abgeschlossen ist, muss sie dem Kunden zur Abnahme übergeben werden. Die Karte wandert demzufolge in ```Customer Feedback``` und wir können in die Kommunikation mit dem Kunden treten. Wichtig ist, dass wir aktiv die Bereitschaft zur Mitarbeit einfordern, die mindestens in einem Abnicken besteht. Unsere Erfahrung zeigt: Je intensiver die Mitarbeit auf Kundenseite ist, desto besser ist das Resultat der Aufgabe. Bekommen wir jetzt Feedback, das eine Anpassung benötigt, muss die Aufgabe unseren Zyklus über ```Preparation``` erneut durchlaufen, damit wir uns als Team (und den Kunden) aktiv vor Scope Creep schützen. Weil wir aber an die Devise "Menschen über Prozesse" glauben, kann bei objektiv feststellbaren Kleinigkeiten diese Regel auch übersprungen und ```Preparation``` umgangen werden.
6. Bekommen wir hingegen ein positives Feedback, wandert die Aufgabe weiter in ```Ready For Release```. Sie verweilen hier so lange, bis der Kunde sie in das Produktionssystem ausgerollt haben möchte.
7. Wenn die Aufgabe dann abgeschlossen wurde, bleibt nur noch der Gang in die ```Done```-Spalte.
...
Das Board ist nicht der eigentliche Grund für unseren Fortschritt. Die Umstellung der Visualisierung unserer Arbeit hat aber dafür gesorgt, dass wir uns bewusst und aktiv über unsere Prozesse austauschen. Unser Mindset hat sich dahingehend geschärft, dass jeder Einzelne die (zumeist kleineren) Baustellen links und rechts von der täglichen Arbeit schneller identifizieren kann. Wir reden (und streiten) viel mehr über Probleme und überlegen uns sinnvolle Lösungen dafür, wie wir unser Leben noch einfacher gestalten können. Und wir können dank des übersichtlich-aktuellen Doings viel effektiver in unserem Daily **(Walk The Board)[https://leuchtfeuer.com/blog/walk-the-board/]** als Methode einsetzen.

Die Endstation ist… es gibt keine Endstation: In regelmäßigen Meetings (Retro, Refinement, Daily) stellen wir den erreichten Status Quo auf den Prüfstand und schauen, wo wir den aktuellen Stand unseres Workflows aus- oder abbauen müssen. Routinen, die nicht mehr zu unserer Arbeitsweise passen, werden herausgestrichen. Wir haben Potenziale darin identifiziert, wie wir den Kunden aktiv an unserem Prozess teilhaben lassen. Andere Verbesserungen sind möglicherweise eine weitestgehend normalisierte Größe der Aufgaben oder eine Präzisierung der Spaltenübergangs-Definitionen. Es gibt immer etwas zu tun, weil sich sowohl unsere Umwelt, aber auch jeder einzelne von uns sich verändert. Mal in kleinen, mal aber auch in großen Schritten. Und daher ist es elementar wichtig, dass man bereit dazu ist, sich von den Dingen zu verändern oder sich gar zu trennen, die gestern noch perfekt funktioniert haben. Auch, wenn es lediglich die Umgestaltung eines drögen Boards ist, bringt der von innen getriebene Wunsch nach Veränderung echten Fortschritt.
